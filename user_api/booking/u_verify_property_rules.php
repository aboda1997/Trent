        ...
        try {
            ...
            if (validateIdAndDatabaseExistance($prop_id, 'tbl_property', ' status = 1 and is_approved =1 and is_deleted =0') === false) {
                ...
                if ($days == 0) {
                    ...
                    $field_values = ["data", "f1", "f2", "created_at", "prop_id", "total", "sub_total", 'uid' , 'guest_count'];
                    $data_values = [$postString, $from_date, $to_date, $created_at, $prop_id, $fp['final_total'], $fp['sub_total'], $uid ,$guest_counts ];
