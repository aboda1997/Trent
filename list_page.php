...
if ($_SESSION['restatename'] == 'Staff' && !in_array('Read', $page_per)) {
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td> <?php echo $title[$lang_code]; ?></td>



                          <?php if ($row['status'] == 1) { ?>

                            <td><span class="badge badge-success"><?= $lang['Publish'] ?></span></td>
                          <?php } else { ?>

                            <td>
                              <span class="badge badge-danger"><?= $lang['Unpublish'] ?></span>
                            </td>
                          <?php } ?>
