      ...
      <div class="container-fluid">
        <div class="page-title">
          <div class="row">
            <div class="col-6">
              <h3>
                Completed Payout Management</h3>
            </div>
            <div class="col-6">
              ...
              <div class="card-body">
                <div class="mb-3 row">
                  <form id="exportForm" method="get" class="col-sm-12">
                    <div class="row justify-content-end align-items-start">
                      ...
                      <input type="hidden" name="payout_status" value="Completed" />
                ...
                <div class="table-responsive">
                  <table class="display" id="basic-1">
                    ...
                    <tbody>
                      <?php
                      $city = $rstate->query("SELECT  p.id as pid,p.requested_at,p.profile_id,b.id, b.total, b.prop_title, b.uid FROM tbl_payout_list p INNER JOIN tbl_book b ON FIND_IN_SET(b.id, p.book_id) > 0 WHERE p.payout_status = 'Completed'");
                      $i = 0;
