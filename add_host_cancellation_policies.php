                            ...
                            <div class="card-body">
                                ...
                                <form onsubmit="return submitform(validateForm(true)) ;"
                                    ...
                                    <div class="tab-content">
                                        <?php
                                        $host_cancellation_policies	 = json_decode($set['host_cancellation_policies'], true);
                                        ?>
                                        <!-- English Tab -->
                                        <div class="tab-pane fade show active" id="en">
                                            <div class="row" style="height: calc(100vh - 150px);"> <!-- Adjust 150px based on your header/footer -->
                                                <div class="form-group mb-3 col-12 h-100"> <!-- Full width + full height -->
                                                    ...
                                                    <?= $lang_en['host_cancellation_policies'] ?>
                                                    </label>
                                                    ...
                                                    <div class="d-flex flex-column border rounded" style="height: calc(100% - 40px);">
                                                        ...
                                                        <textarea
                                                            ...
                                                            placeholder="<?= $lang_en['Enter_Host_Cancellation_Policies'] ?>"

                                                            name="host_cancellation_policies_en"
                                                            required
                                                            style="min-height: 300px;"><?php echo htmlspecialchars($host_cancellation_policies['en'] ?? ''); ?></textarea>
                                                    </div>

                                                    <input type="hidden" name="type" value="edit_host_cancellation_policies" />
                                                    <input type="hidden" name="id" value="1" />
                                                    <div class="invalid-feedback" id="host_cancellation_policies_en_feedback" style="display: none;">
                                                        <?= $lang_en['host_cancellation_policies_feedback'] ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade show " id="ar">
                                            <div class="row" style="height: calc(100vh - 150px);"> <!-- Adjust 150px based on your header/footer -->
                                                <div class="form-group mb-3 col-12 h-100"> <!-- Full width + full height -->
                                                    <label><span class="text-danger">*</span>                                                        
                                                    <?= $lang_ar['host_cancellation_policies'] ?>
                                                    ...
                                                    <div class="d-flex flex-column border rounded" style="height: calc(100% - 40px);">
                                                        ...
                                                        <textarea
                                                            class="form-control flex-grow-1 border-0 resize-none"
                                                            placeholder="<?= $lang_ar['Enter_Host_Cancellation_Policies'] ?>"

                                                            name="host_cancellation_policies_ar"
                                                            required 
                                                            style="min-height: 300px;"><?php echo htmlspecialchars($host_cancellation_policies['ar'] ?? ''); ?></textarea>
                                                    </div>

                                                    <input type="hidden" name="type" value="edit_host_cancellation_policies" />
                                                    <input type="hidden" name="id" value="1" />
                                                    <div class="invalid-feedback" id="host_cancellation_policies_ar_feedback" style="display: none;">
                                                        <?= $lang_ar['host_cancellation_policies_feedback'] ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    function validateForm(edit = false) {
        ...
        const terms_ar = document.querySelector('textarea[name="host_cancellation_policies_ar"]').value;
        const terms_en = document.querySelector('textarea[name="host_cancellation_policies_en"]').value;
        ...
        if (!terms_ar) {
            document.getElementById('host_cancellation_policies_ar_feedback').style.display = 'block';
            isArabicValid = false;
        }
        if (!terms_en) {
            document.getElementById('host_cancellation_policies_en_feedback').style.display = 'block';
    ...
    if (document.getElementById('edit_host_cancellation_policies')) {
      document.querySelector('button[type="submit"]').textContent = langData.edit_host_cancellation_policies;
