                                    ...
                                    <table class="display" id="basic-1">
                                        ...
                                        <tbody>
                                            ...
                                            $city = $rstate->query("SELECT 
                                                ...
                                                u.ccode,
                                                u.mobile,
                                                (SELECT COUNT(*) FROM tbl_book WHERE uid = u.id) AS booking_count,
                                                (SELECT COUNT(*) FROM tbl_property WHERE add_user_id = u.id) AS property_count
                                            FROM 
                                                tbl_user u
                                            WHERE 
                                                EXISTS (
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="align-middle">
                                                        <?php echo $row['property_count']; ?>
                                                    </td>
                                                    <td class="align-middle">
                                                        <?php
                                                        echo $row['property_count'] > 5 ? 'Property Manager' : 'Owner';
                                                        ?>
                                                    </td>
                                                </tr>
                                            <?php
        ...
        $('#confirmSendBtn').click(function() {
            ...
            $.ajax({
                ...
                data: {
                    ...
                    message: message,
                    type: 'send_owner_whatsup_message'
                },
