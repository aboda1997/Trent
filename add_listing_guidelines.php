                            ...
                            <div class="card-body">
                                ...
                                <form onsubmit="return submitform(validateForm(true)) ;"
                                    ...
                                    <div class="tab-content">
                                        <?php
                                        $listing_guidelines	 = json_decode($set['listing_guidelines'], true);
                                        ?>
                                        <!-- English Tab -->
                                                ...
                                                <div class="form-group mb-3 col-12 h-100"> <!-- Full width + full height -->
                                                    ...
                                                    <div class="d-flex flex-column border rounded" style="height: calc(100% - 40px);">
                                                        ...
                                                        <textarea
                                                            ...
                                                            placeholder="<?= $lang_en['Enter_Listing_Guidelines'] ?>"

                                                            name="listing_guidelines_en"
                                                            required
                                                            style="min-height: 300px;"><?php echo htmlspecialchars($listing_guidelines['en'] ?? ''); ?></textarea>
                                                    </div>

                                                    <input type="hidden" name="type" value="edit_listing_guidelines" />
                                                    <input type="hidden" name="id" value="1" />
                                                    <div class="invalid-feedback" id="listing_guidelines_en_feedback" style="display: none;">
                                                        <?= $lang_en['listing_guidelines_feedback'] ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="row" style="height: calc(100vh - 150px);"> <!-- Adjust 150px based on your header/footer -->
                                                <div class="form-group mb-3 col-12 h-100"> <!-- Full width + full height -->
                                                    ...
                                                    <div class="d-flex flex-column border rounded" style="height: calc(100% - 40px);">
                                                        ...
                                                        <textarea
                                                            class="form-control flex-grow-1 border-0 resize-none"
                                                            placeholder="<?= $lang_ar['Enter_Listing_Guidelines'] ?>"

                                                            name="listing_guidelines_ar"
                                                            required
                                                            style="min-height: 300px;"><?php echo htmlspecialchars($listing_guidelines['ar'] ?? ''); ?></textarea>
                                                    </div>

                                                    <input type="hidden" name="type" value="edit_listing_guidelines" />
                                                    <input type="hidden" name="id" value="1" />
                                                    <div class="invalid-feedback" id="listing_guidelines_ar_feedback" style="display: none;">
                                                        <?= $lang_ar['listing_guidelines_feedback'] ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="card-footer text-left">
                                        <button onclick="return validateForm(true)" type="submit" id="edit_listing_guidelines" name="edit_listing_guidelines" class="btn btn-primary mb-2">
                                        <?= $lang_en['edit_listing_guidelines'] ?>
...
<script>
    ...
    function validateForm(edit = false) {
        ...
        const guidelines_ar = document.querySelector('textarea[name="listing_guidelines_ar"]').value;
        const guidelines_en = document.querySelector('textarea[name="listing_guidelines_en"]').value;
        ...
        if (!guidelines_ar) {
            document.getElementById('listing_guidelines_ar_feedback').style.display = 'block';
            isArabicValid = false;
        }
        if (!guidelines_en) {
            document.getElementById('listing_guidelines_en_feedback').style.display = 'block';
    ...
    if (document.getElementById('edit_listing_guidelines')) {
      document.querySelector('button[type="submit"]').textContent = langData.edit_listing_guidelines;
