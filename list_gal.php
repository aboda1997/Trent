                  ...
                  <table class="display" id="basic-1">
                    <thead>
                      <tr>
                        ...
                        <?php
                        if (in_array('Update_Gallery', $per) || in_array('Delete_Gallery', $per)) {
                        ?>
                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td class="align-middle">
                            <?php $pro = $rstate->query("select * from tbl_gal_cat where id=" . $row['cat_id'] . "")->fetch_assoc();
                            echo $pro['title']; ?>
                          </td>
