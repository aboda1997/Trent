                ...
                <div class="mb-3 row">
                  <form id="exportForm" method="get" class="col-sm-12">
                    <div class="row justify-content-end align-items-start">
                      <input type="hidden" name="type" value="export_user_cancel_reason_data" />
                  ...
                  <table class="display" id="basic-1">
                    <thead>
                      <tr>
                        ...
                        <?php
                        if (in_array('Update_Cancel_Reason', $per) || in_array('Delete_Cancel_Reason', $per)) {
                        ?>
                    ...
                    <tbody>
                      <?php
                      $city = $rstate->query("select * from tbl_user_cancel_reason");
                      $i = 0;
                            ...
                            <td style="white-space: nowrap; width: 15%;">
                              <div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                <div class="btn-group btn-group-sm" style="float: none;">
                                  <a href="add_user_cancel_reason.php?id=<?php echo $row['id']; ?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
