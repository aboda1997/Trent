...
<div class="page-wrapper compact-wrapper" id="pageWrapper">
                 ...
                 <div class="mb-3 row">
                  <form id="exportForm" method="get" class="col-sm-12">
                    <div class="row justify-content-end align-items-start">
                      <input type="hidden" name="type" value="export_payout_method_data" />
 ...
 <th>
                        ...
                        <?php
                        if (in_array('Update_Payout_Method', $per) || in_array('Delete_Payout_Method', $per)) {
                        ?>
                              ...
                              <td style="white-space: nowrap; width: 15%;">
                                <div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                  <div class="btn-group btn-group-sm" style="float: none;">
                                    <a href="add_payout_method.php?id=<?php echo $row['id']; ?>" class="tabledit-edit-button" style="float: none; margin: 5px;">
