                            ...
                            <div class="card-body">
                                ...
                                <form onsubmit="return submitform(validateForm(true)) ;"
                                    ...
                                    <div class="tab-content">
                                        <?php
                                        $host_terms_and_conditions	 = json_decode($set['host_terms_and_conditions'], true);
                                        ?>
                                        <!-- English Tab -->
                                        <div class="tab-pane fade show active" id="en">
                                            <div class="row" style="height: calc(100vh - 150px);"> <!-- Adjust 150px based on your header/footer -->
                                                <div class="form-group mb-3 col-12 h-100"> <!-- Full width + full height -->
                                                    ...
                                                    <?= $lang_en['host_terms_and_conditions'] ?>
                                                    </label>
                                                    ...
                                                    <div class="d-flex flex-column border rounded" style="height: calc(100% - 40px);">
                                                        ...
                                                        <textarea
                                                            ...
                                                            placeholder="<?= $lang_en['Enter_Host_Terms'] ?>"

                                                            name="host_terms_en"
                                                            required
                                                            style="min-height: 300px;"><?php echo htmlspecialchars($host_terms_and_conditions['en'] ?? ''); ?></textarea>
                                                    </div>

                                                    <input type="hidden" name="type" value="edit_host_terms" />
                                                    <input type="hidden" name="id" value="1" />
                                                    <div class="invalid-feedback" id="host_terms_en_feedback" style="display: none;">
                                                        <?= $lang_en['host_terms_feedback'] ?>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="tab-pane fade show " id="ar">
                                            <div class="row" style="height: calc(100vh - 150px);"> <!-- Adjust 150px based on your header/footer -->
                                                <div class="form-group mb-3 col-12 h-100"> <!-- Full width + full height -->
                                                    <label><span class="text-danger">*</span>                                                        
                                                    <?= $lang_ar['host_terms_and_conditions'] ?>
                                                    ...
                                                    <div class="d-flex flex-column border rounded" style="height: calc(100% - 40px);">
                                                        ...
                                                        <textarea
                                                            class="form-control flex-grow-1 border-0 resize-none"
                                                            placeholder="<?= $lang_ar['Enter_Host_Terms'] ?>"
                                    ...
                                    <div class="card-footer text-left">
                                        <button onclick="return validateForm(true)" type="submit" id="edit_host_terms" name="edit_host_terms" class="btn btn-primary mb-2">
                                        <?= $lang_en['edit_host_terms'] ?>
...
<script>
    ...
    function validateForm(edit = false) {
        ...
        const terms_ar = document.querySelector('textarea[name="host_terms_ar"]').value;
        const terms_en = document.querySelector('textarea[name="host_terms_en"]').value;
        ...
        if (!terms_ar) {
            document.getElementById('host_terms_ar_feedback').style.display = 'block';
            isArabicValid = false;
        }
        if (!terms_en) {
            document.getElementById('host_terms_en_feedback').style.display = 'block';
    ...
    if (document.getElementById('edit_host_terms')) {
      document.querySelector('button[type="submit"]').textContent = langData.edit_host_terms;
